...
3. Cut a **GitHub Release** (e.g. `v1.1.0`). Zenodo automatically mints a DOI and archives the release.
...
> Pakhare, A., & Joshi, A. (2026). *NFHS India Explorer: a harmonised NFHS-3 to NFHS-6 fact-sheet database and dashboard* (v1.1.0) [Software]. Zenodo. https://doi.org/10.5281/zenodo.20460014
